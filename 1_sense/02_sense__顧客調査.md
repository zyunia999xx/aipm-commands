...
- trigger: "(sense_顧客調査|Customer Research)"
  ...
  steps:
    ...
    - name: "ensure_output_dir"
      ...
      command: "mkdir -p {{patterns.flow_date}}/1_sense/02_sense__顧客調査"
    ...
    - name: "create_draft"
      ...
      path: "{{patterns.flow_date}}/1_sense/02_sense__顧客調査/sense_customer_research.md"
      template_reference: "basic/02_pmbok_research.mdc => customer_research_template"
```

## 次に実行
- `01_sense__競合調査` と合わせてインサイトをプール
