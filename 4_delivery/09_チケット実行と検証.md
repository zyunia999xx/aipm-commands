...
- trigger: "(実装_チケット実行と検証|TicketRun)"
  ...
  steps:
    ...
    - name: "create_or_update_files"
      ...
      base_path: "Flow/{{today}}/{{flow_dir}}/08_チケット開始/{{task_id}}/"
      message: "実装ファイルを作成・更新しています..."
    ...
    - name: "guide_browser_testing"
      ...
      content: |
        ...
        1. **ファイルを開く**:
           - `Flow/{{today}}/{{flow_dir}}/08_チケット開始/{{task_id}}/index.html` をブラウザで開く
