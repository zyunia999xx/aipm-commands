...
- trigger: "(設計_Drawioスクリーン生成|GenerateDrawioScreens)"
  ...
  steps:
    ...
    - name: "generate_sc1_drawio"
      ...
      path: "Flow/{{today}}/{{flow_dir}}/06_設計__Drawioスクリーン生成/drawio/SC1.drawio"
      content: |
    ...
    - name: "generate_sc2_drawio"
      action: "create_markdown_file"
      path: "Flow/{{today}}/{{flow_dir}}/06_設計__Drawioスクリーン生成/drawio/SC2.drawio"
      content: |
        <mxfile host="app.diagrams.net" type="device">
    ...
    - name: "display_result"
      ...
      content: |
        ✅ 生成しました：
        - `06_設計__Drawioスクリーン生成/drawio/SC1.drawio`
        - `06_設計__Drawioスクリーン生成/drawio/SC2.drawio`
